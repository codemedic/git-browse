(function () {
  ...
  var SVG_THEME_AUTO   = '<svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M5.029 2.217a6.5 6.001 0 0 1 9.418 7.443.75.75 0 1 0 1.46.34 8 8 0 1 0-11.364 0 .75.75 0 1 0 1.46-.34 6.5 6.001 0 0 1-.974-7.443z"></path></svg>';
